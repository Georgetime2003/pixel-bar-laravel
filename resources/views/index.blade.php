...
<html lang="en">
    ...
    <body>
        ...
        <!-- Boto idioma a la cantonada superior dreta -->
        <div style="position:fixed;top:20px;right:30px;z-index:2;">
            <div class="dropdown">
                <button class="dropbtn"><img src="/img/flags/globe.svg" alt="Lang" style="width:24px;vertical-align:middle;"> <span id="selected-lang">EN</span> ▼</button>
        ...
        <div class="center-card">
            <img src="{{ asset('img/logo.png') }}" alt="Logo" class="logo-main">
            <div class="btn-group">
                <a class="neon-btn" href="{{ route('login') }}" data-i18n="login">Iniciar Sessió</a>
                <a class="neon-btn" href="{{ route('register') }}" data-i18n="register">Registrar-se</a>
                <a class="neon-btn" href="{{ route('menu') }}" data-i18n="menu">Menú</a>
                <a class="neon-btn" href="{{ route('contact') }}" data-i18n="contact">Contacte</a>
            </div>
        </div>
    </body>
